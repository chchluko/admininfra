...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Edicion de Switch</h3>
        <div class="card-tools">
            <a type="link" href="/switchs" class="btn btn-tool"><i class="fas fa-list"></i></a>
        </div>
    </div>
    <!-- /.card-header -->
    ...
    <div class="card-body">@include('partials.alert')
        {!! Form::model($switch, ['route'=>['switchs.update',$switch],'method'=>'PUT']) !!}
