...
@section('content')
    <div class="card card-primary">
        ...
        <div class="card-tools">
            <a type="link" href="{{ route('screens.create') }}" class="btn btn-tool"><i class="fas fa-plus"></i></a>
        </div>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td class="py-0 text-right align-middle">
                                <div class="btn-group btn-group-sm">
                                  <a href="{{ route('screens.edit',$hardware->id ) }}" class="btn btn-default"><i class="fas fa-edit"></i></a>
                                  <a href="{{ route('screens.show',$hardware->id ) }}" class="btn btn-default"><i class="fas fa-eye"></i></a>
                                </div>
                              </td>
                        </tr>
