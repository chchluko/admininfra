...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Edicion de Sistemas Operativos</h3>
        <div class="card-tools">
            <a type="link" href="{{ route('operatings.index') }}" class="btn btn-tool"><i class="fas fa-list"></i></a>
        </div>
    </div>
    <!-- /.card-header -->
    ...
    <div class="card-body">@include('partials.alert')
        {!! Form::model($operating, ['route'=>['operatings.update',$operating],'method'=>'PUT']) !!}
