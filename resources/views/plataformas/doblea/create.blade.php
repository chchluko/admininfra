...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Alta de Aire Acondicionado</h3>
        <div class="card-tools">
            <a type="link" href="{{ route('doblea.index') }}" class="btn btn-tool"><i class="fas fa-list"></i></a>
        </div>
    </div>
    <!-- /.card-header -->
