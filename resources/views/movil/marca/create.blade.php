...
<div class="card card-primary">
    <div class="card-header">
      <h3 class="card-title">Alta de Marca de Equipo</h3>
      <div class="card-tools">
        <a type="link" href="/movilmarca" class="btn btn-tool"><i class="fas fa-list"></i></a>
      </div>
    </div>
    <!-- /.card-header -->
    ...
    <div class="card-body">@include('partials.alert')
          <form action="{{ route('movilmarca.store') }}" method="POST">
            @csrf
