...
<div class="card card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a type="link" href="{{ route('asignacionmovil.index') }}" class="btn btn-tool"><i
...
@livewire('assigned-movil.resources', ['asignacionmovil' => $asignacionmovil], key('movil-resources'.$asignacionmovil->id))
@stop
