    ...
    <div class="card-body">
        <form action="{{ route('movil.store') }}" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    {!! Form::select('warehouse_id', $warehouses, 0, ['class' => 'form-control']) !!}
            ...
            <div class="form-group row">
                <div class="col-6"> <label for="imei">IMEI</label>
                    <input type="text" name="imei" class="form-control {{ $errors->has('imei') ? 'field-error' : '' }}"
                        id="modelo" placeholder="#########" value="{{ old('imei') }}">
                    @if ($errors->has('imei'))
